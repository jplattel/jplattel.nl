...
Simple tools are the best. As I'm living in the Netherlands one of the tools I frequently use is buienradar, the weatherforecast allows me to make a choice on when to hop on a bicycle (or not!). I used their app, the one from RIVM as well, but visiting the website always felt as the least pleasent way of using it. 
...
_I know I could add loads of options (using location, prediction graphs etc), I'll leave to to you (or an LLM!) as an exercise, feel free to make a pull-request as I lack the time and I'm happy with this result!_